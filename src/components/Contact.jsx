  ...
  return (
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-gradient-to-r from-sky-400/10 to-teal-400/10 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
              ...
              {contactInfo.map((contact, index) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 bg-gradient-to-r from-[#2968A3] to-sky-500 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
            ...
            {/* Quick Actions */}
            <div className="bg-gradient-to-br from-white to-sky-50 rounded-2xl p-8 shadow-card border border-gray-100">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-8 h-8 bg-gradient-to-r from-[#2968A3] to-sky-500 rounded-lg flex items-center justify-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  asChild
                  size="lg"
                  className="flex-1 bg-gradient-to-r from-[#2968A3] to-sky-500 hover:from-[#1E5580] hover:to-sky-600 px-6 py-4 text-base"
                >
                  <a
                    href="tel:+421904237003"
          ...
          {/* CTA Section */}
          <div className="bg-gradient-to-br from-gray-900 via-[#2968A3] to-gray-900 rounded-3xl p-12 text-white relative overflow-hidden">
            <div className="relative z-10">
              ...
              <Button
                size="lg"
                className="bg-gradient-to-r from-sky-500 to-teal-500 hover:from-sky-600 hover:to-teal-500 text-white font-semibold px-8 py-4 group shadow-lg"
                asChild
              >
                <a
                  href="mailto:marek.zacik@maradlo.sk"
            ...
            <div className="absolute -top-20 -right-20 w-40 h-40 bg-gradient-to-r from-sky-400/20 to-teal-400/20 rounded-full blur-xl"></div>
            <div className="absolute -bottom-10 -left-10 w-32 h-32 bg-gradient-to-r from-[#2968A3]/30 to-sky-400/20 rounded-full blur-xl"></div>
